...
> **Last scan:** 2026-08-26 05:04 UTC · **Target:** `Docker build for `v0.2.3` (image `0.2.3`)` · Docker image `ghcr.io/wildfirebill-ai/localai-code-editor:0.2.3`
> [Full run logs](https://github.com/wildfirebill-ai/localai-code-editor/actions/runs/32932364286) — generated by the security-scan workflow. Do not edit this section manually.

### Docker image `ghcr.io/wildfirebill-ai/localai-code-editor:0.2.3` (OS + library packages; unfixed vulns ignored)
