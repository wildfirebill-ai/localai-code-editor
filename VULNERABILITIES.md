...
> **Last scan:** 2026-09-07 11:33 UTC · **Target:** `scheduled weekly scan (latest image)` · Docker image `ghcr.io/wildfirebill-ai/localai-code-editor:latest`
> [Full run logs](https://github.com/wildfirebill-ai/localai-code-editor/actions/runs/34117126247) — generated by the security-scan workflow. Do not edit this section manually.

### Docker image `ghcr.io/wildfirebill-ai/localai-code-editor:latest` (OS + library packages; unfixed vulns ignored)

**Totals:** 0 critical · 2 high · 0 medium · 0 low
...
**Totals:** 1 critical · 15 high · 9 moderate
...
| MODERATE | qs | qs array-limit bypass via bracket-key comma parsing ([ref](https://github.com/advisories/GHSA-x5fp-wj9c-mxmx)) | >=6.14.2 <=6.15.3 | >=6.16.0 |
| MODERATE | qs | qs: Denial of Service via Attacker Controlled isBuffer ([ref](https://github.com/advisories/GHSA-4mjr-xmp4-gh2g)) | >=2.2.5 <6.16.0 | >=6.16.0 |
| MODERATE | @xmldom/xmldom | xmldom: XML fragment injection via invalid EntityReference.nodeName during requireWellForm ([ref](https://github.com/advisories/GHSA-6gmq-8vp8-gcm6)) | >=0.9.0 <=0.9.11 | >=0.9.12 |
