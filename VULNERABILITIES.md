...
> **Last scan:** 2026-08-23 15:13 UTC · **Target:** `Docker build for `v0.1.9` (image `0.1.9`)` · Docker image `ghcr.io/wildfirebill-ai/localai-code-editor:0.1.9`
> [Full run logs](https://github.com/wildfirebill-ai/localai-code-editor/actions/runs/32647692176) — generated by the security-scan workflow. Do not edit this section manually.

### Docker image `ghcr.io/wildfirebill-ai/localai-code-editor:0.1.9` (OS + library packages; unfixed vulns ignored)
