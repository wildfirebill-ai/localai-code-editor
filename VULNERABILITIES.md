...
> **Last scan:** 2026-08-25 18:21 UTC · **Target:** `Docker build for `v0.2.2` (image `0.2.2`)` · Docker image `ghcr.io/wildfirebill-ai/localai-code-editor:0.2.2`
> [Full run logs](https://github.com/wildfirebill-ai/localai-code-editor/actions/runs/32882897160) — generated by the security-scan workflow. Do not edit this section manually.

### Docker image `ghcr.io/wildfirebill-ai/localai-code-editor:0.2.2` (OS + library packages; unfixed vulns ignored)
