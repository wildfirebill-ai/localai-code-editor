...
> **Last scan:** 2026-08-22 15:18 UTC · **Target:** `manual dispatch (workflow_dispatch)` · Docker image `ghcr.io/wildfirebill-ai/localai-code-editor:0.1.6`
> [Full run logs](https://github.com/wildfirebill-ai/localai-code-editor/actions/runs/32581240884) — generated by the security-scan workflow. Do not edit this section manually.

### Docker image `ghcr.io/wildfirebill-ai/localai-code-editor:0.1.6` (OS + library packages; unfixed vulns ignored)

**Totals:** 16 critical · 317 high · 0 medium · 0 low
...
_…and 303 more HIGH/CRITICAL findings truncated._
