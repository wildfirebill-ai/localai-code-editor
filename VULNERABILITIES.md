...
> **Last scan:** 2026-08-24 06:53 UTC · **Target:** `scheduled weekly scan (latest image)` · Docker image `ghcr.io/wildfirebill-ai/localai-code-editor:latest`
> [Full run logs](https://github.com/wildfirebill-ai/localai-code-editor/actions/runs/32699095211) — generated by the security-scan workflow. Do not edit this section manually.
