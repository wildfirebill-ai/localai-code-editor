...
> **Last scan:** 2026-08-22 16:19 UTC · **Target:** `Docker build for `main` (image `latest`)` · Docker image `ghcr.io/wildfirebill-ai/localai-code-editor:latest`
> [Full run logs](https://github.com/wildfirebill-ai/localai-code-editor/actions/runs/32584287987) — generated by the security-scan workflow. Do not edit this section manually.
