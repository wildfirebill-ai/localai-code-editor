...
> **Last scan:** 2026-09-14 11:45 UTC · **Target:** `scheduled weekly scan (latest image)` · Docker image `ghcr.io/wildfirebill-ai/localai-code-editor:latest`
> [Full run logs](https://github.com/wildfirebill-ai/localai-code-editor/actions/runs/34839740908) — generated by the security-scan workflow. Do not edit this section manually.

### Docker image `ghcr.io/wildfirebill-ai/localai-code-editor:latest` (OS + library packages; unfixed vulns ignored)

**Totals:** 0 critical · 4 high · 0 medium · 0 low

| Severity | ID | Package | Installed | Fixed | Title |
|---|---|---|---|---|---|
| HIGH | CVE-2026-14456 | libcrypto3 | 3.5.7-r0 | 3.5.8-r0 | openssl: OpenSSL: Denial of Service via unbounded memory growth in QUIC server |
| HIGH | CVE-2026-76956 | libexpat | 2.8.3-r0 | 2.8.4-r0 | libexpat: libexpat: Denial of Service via hash flooding attack with crafted XML |
| HIGH | CVE-2026-76957 | libexpat | 2.8.3-r0 | 2.8.4-r0 | libexpat: libexpat: Memory corruption vulnerability allows arbitrary code execution or den |
| HIGH | CVE-2026-14456 | libssl3 | 3.5.7-r0 | 3.5.8-r0 | openssl: OpenSSL: Denial of Service via unbounded memory growth in QUIC server |
...
| Severity | ID | Package | Installed | Fixed | Title |
|---|---|---|---|---|---|
| HIGH | CVE-2026-75899 | fast-uri | 3.1.5 | 2.4.5, 3.1.6, 4.1.3 | fast-uri: fast-uri: Server-Side Request Forgery via repeated hostname percent-decoding |
| HIGH | CVE-2026-75931 | fast-uri | 3.1.5 | 2.4.5, 3.1.6, 4.1.3 | fast-uri: fast-uri: Host confusion via skipped IDN canonicalization |
| HIGH | CVE-2026-75975 | fast-uri | 3.1.5 | 2.4.5, 3.1.6, 4.1.3 | fast-uri: fast-uri: Server-side request forgery via malformed IPv6 normalization |
| HIGH | CVE-2026-76172 | fast-uri | 3.1.5 | 2.4.5, 3.1.6, 4.1.3 | fast-uri: fast-uri: URI parsing flaw enables server-side request forgery and redirects |

### Repository dependencies (pnpm audit)

**Totals:** 1 critical · 25 high · 13 moderate
...
| HIGH | fast-uri | fast-uri vulnerable to host confusion via skipped IDN canonicalization on scheme-relative  ([ref](https://github.com/advisories/GHSA-5jgf-p345-68v8)) | >=3.1.3 <3.1.6 | >=3.1.6 |
| HIGH | fast-uri | fast-uri vulnerable to server-side request forgery via malformed IPv6 normalization ([ref](https://github.com/advisories/GHSA-f65p-4m7j-42xc)) | >=3.0.0 <3.1.6 | >=3.1.6 |
| HIGH | fast-uri | fast-uri vulnerable to server-side request forgery via repeated hostname percent-decoding ([ref](https://github.com/advisories/GHSA-fph4-wmhf-6fwf)) | >=3.1.2 <3.1.6 | >=3.1.6 |
| HIGH | fast-uri | fast-uri vulnerable to host confusion via percent-encoded scheme normalization ([ref](https://github.com/advisories/GHSA-jqff-g426-hqxp)) | >=3.0.0 <3.1.6 | >=3.1.6 |
| HIGH | @xmldom/xmldom | xmldom: HTML raw-text closing-tag case mismatch causes output amplification ([ref](https://github.com/advisories/GHSA-6mj3-qw4j-hgrw)) | >=0.9.0-beta.1 <=0.9.11 | >=0.9.12 |
| HIGH | @xmldom/xmldom | xmldom: Processing Instruction Target Injection Bypasses requireWellFormed ([ref](https://github.com/advisories/GHSA-c7q8-3ch8-vqpv)) | >=0.9.0 <=0.9.11 | >=0.9.12 |
| HIGH | @xmldom/xmldom | xmldom: requireWellFormed element/attribute name validation is bypassable via an embedded  ([ref](https://github.com/advisories/GHSA-jxjr-3g7g-3944)) | =0.9.11 | >=0.9.12 |
| HIGH | @xmldom/xmldom | xmldom: DocType `name` Injection Bypasses requireWellFormed ([ref](https://github.com/advisories/GHSA-27p8-2357-5qqv)) | >=0.9.0 <=0.9.11 | >=0.9.12 |
| HIGH | @xmldom/xmldom | xmldom: Creation-time XML Name/QName validation is bypassable via an embedded line termina ([ref](https://github.com/advisories/GHSA-3px3-54cx-rmw9)) | >=0.9.0 <=0.9.11 | >=0.9.12 |
| HIGH | @xmldom/xmldom | xmldom: requireWellFormed DocType publicId/systemId validation is bypassable via an embedd ([ref](https://github.com/advisories/GHSA-vr34-hp96-76pp)) | >=0.9.10 <=0.9.11 | >=0.9.12 |
| HIGH | @xmldom/xmldom | xmldom: Quadratic-time attribute deduplication ([ref](https://github.com/advisories/GHSA-8344-3jmq-59r6)) | >=0.9.0 <=0.9.11 | >=0.9.12 |
| HIGH | @xmldom/xmldom | xmldom: Quadratic-memory consumption ([ref](https://github.com/advisories/GHSA-965w-775f-mr7g)) | >=0.9.0 <=0.9.11 | >=0.9.12 |
| HIGH | @xmldom/xmldom | xmldom: Quadratic-time parsing via the malformed-input recovery path — `parseElementStartP ([ref](https://github.com/advisories/GHSA-93r5-fhx6-vmg9)) | >=0.9.0 <=0.9.11 | >=0.9.12 |
| HIGH | js-yaml | js-yaml: maxTotalMergeKeys does not limit CPU use for empty merge sources ([ref](https://github.com/advisories/GHSA-2883-xcg3-v3hh)) | >=4.0.0 <4.3.2 | >=4.3.2 |
