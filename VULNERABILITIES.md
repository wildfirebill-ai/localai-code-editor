...
> **Last scan:** 2026-08-25 15:25 UTC · **Target:** `Docker build for `v0.2.1` (image `0.2.1`)` · Docker image `ghcr.io/wildfirebill-ai/localai-code-editor:0.2.1`
> [Full run logs](https://github.com/wildfirebill-ai/localai-code-editor/actions/runs/32865310530) — generated by the security-scan workflow. Do not edit this section manually.

### Docker image `ghcr.io/wildfirebill-ai/localai-code-editor:0.2.1` (OS + library packages; unfixed vulns ignored)
