...
> **Last scan:** 2026-08-25 06:49 UTC · **Target:** `Docker build for `v0.2.0` (image `0.2.0`)` · Docker image `ghcr.io/wildfirebill-ai/localai-code-editor:0.2.0`
> [Full run logs](https://github.com/wildfirebill-ai/localai-code-editor/actions/runs/32818364982) — generated by the security-scan workflow. Do not edit this section manually.

### Docker image `ghcr.io/wildfirebill-ai/localai-code-editor:0.2.0` (OS + library packages; unfixed vulns ignored)
