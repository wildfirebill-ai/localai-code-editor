...
> **Last scan:** 2026-08-26 07:41 UTC · **Target:** `Docker build for `v0.2.6` (image `0.2.6`)` · Docker image `ghcr.io/wildfirebill-ai/localai-code-editor:0.2.6`
> [Full run logs](https://github.com/wildfirebill-ai/localai-code-editor/actions/runs/32943671456) — generated by the security-scan workflow. Do not edit this section manually.

### Docker image `ghcr.io/wildfirebill-ai/localai-code-editor:0.2.6` (OS + library packages; unfixed vulns ignored)
