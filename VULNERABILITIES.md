...
> **Last scan:** 2026-08-21 21:02 UTC · **Target:** `manual dispatch (workflow_dispatch)` · Docker image `ghcr.io/wildfirebill-ai/localai-code-editor:0.1.5`
> [Full run logs](https://github.com/wildfirebill-ai/localai-code-editor/actions/runs/32526574887) — generated by the security-scan workflow. Do not edit this section manually.

### Docker image `ghcr.io/wildfirebill-ai/localai-code-editor:0.1.5` (OS + library packages; unfixed vulns ignored)

_Scan result unavailable (artifact missing)._
