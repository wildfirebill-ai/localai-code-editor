...
> **Last scan:** 2026-08-27 12:11 UTC · **Target:** `Docker build for `v0.2.7` (image `0.2.7`)` · Docker image `ghcr.io/wildfirebill-ai/localai-code-editor:0.2.7`
> [Full run logs](https://github.com/wildfirebill-ai/localai-code-editor/actions/runs/33070446854) — generated by the security-scan workflow. Do not edit this section manually.

### Docker image `ghcr.io/wildfirebill-ai/localai-code-editor:0.2.7` (OS + library packages; unfixed vulns ignored)
