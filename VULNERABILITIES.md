...
> **Last scan:** 2026-08-22 22:36 UTC · **Target:** `Docker build for `v0.1.7` (image `0.1.7`)` · Docker image `ghcr.io/wildfirebill-ai/localai-code-editor:0.1.7`
> [Full run logs](https://github.com/wildfirebill-ai/localai-code-editor/actions/runs/32602752186) — generated by the security-scan workflow. Do not edit this section manually.

### Docker image `ghcr.io/wildfirebill-ai/localai-code-editor:0.1.7` (OS + library packages; unfixed vulns ignored)
