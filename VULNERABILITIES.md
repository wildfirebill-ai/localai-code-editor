...
> **Last scan:** 2026-08-25 16:08 UTC · **Target:** `Docker build for `v0.2.1` (image `0.2.1`)` · Docker image `ghcr.io/wildfirebill-ai/localai-code-editor:0.2.1`
> [Full run logs](https://github.com/wildfirebill-ai/localai-code-editor/actions/runs/32869720339) — generated by the security-scan workflow. Do not edit this section manually.
